...
translations = {
    "English": {
        ...
        "nutshell_text": "This app estimates neuroblastoma risk based on symptoms, lab results, and optional scan analysis.",
        "major_symptoms": "Major symptoms",
        "rarer_symptoms": "Rarer symptoms",
        ...
        "risk_high": "High risk",
        "suggestions_low": "• Low risk; routine follow-up may be enough.\n• Monitor for new symptoms.",
        "suggestions_mild": "• Mild risk; discuss with a pediatrician.\n• Consider basic screening tests.",
        "suggestions_moderate": "• Moderate risk; specialist evaluation recommended.\n• Imaging and lab tests advised.",
        "suggestions_high": "• **High risk; urgent specialist evaluation recommended.**\n• Immediate imaging and specialist consult.",
        "risk_ref_title": "How to interpret the risk",
    ...
    "Spanish": {
        ...
        "disclaimer": "*Esta herramienta es solo para fines educativos y no reemplaza el consejo médico profesional.*",
        "nutshell_title": "En resumen",
        "nutshell_text": "Esta app estima el riesgo de neuroblastoma basado en síntomas, resultados de laboratorio y análisis opcional de escaneos.",
    ...
    "French": {
        ...
        "disclaimer": "*Cet outil est à des fins éducatives uniquement et ne remplace pas un avis médical professionnel.*",
        "nutshell_title": "En résumé",
        "nutshell_text": "Cette application estime le risque de neuroblastome basé sur les symptômes, les résultats de laboratoire et l'analyse optionnelle de scanner.",
